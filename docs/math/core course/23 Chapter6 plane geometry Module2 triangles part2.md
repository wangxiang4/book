...
- Formulas used  
  ...
  \frac{S_1}{S_2}=\frac{h_1}{h_2} & a\textsf{ are equal} \\
  S_1=S_2 & a,h\textsf{ are equal} \\
  \end{cases} & \href{/math/core%20course/23%20Chapter6%20plane%20geometry%20Module2%20triangles%20part2.html#_6-focus-3}{\textsf{triangle area formula properties}} \\
  \end{array}
  >$
...
- Formulas used  
  ...
  >$
  \begin{array}{ll}
  \frac{S_{\triangle ADE}}{S_{\triangle ABC}}=\frac{AD\cdot AE}{AB\cdot AC} & \href{/math/core%20course/23%20Chapter6%20plane%20geometry%20Module2%20triangles%20part2.html#_10-area-ratio-theorem-for-common-angle-triangles}{\textsf{common-angle triangles – area ratio theorem}} \\
  \end{array}
  >$
...
- Formulas used  
  ...
  >$
  \begin{array}{ll}
  \frac{S_{\triangle AOB}}{S_{\triangle AOC}}=\frac{BD}{CD} & \href{/math/core%20course/23%20Chapter6%20plane%20geometry%20Module2%20triangles%20part2.html#_12-area-ratio-theorem-for-concurrent-cevians}{\textsf{concurrent cevians – area ratio theorem}} \\
  \end{array}
  >$
