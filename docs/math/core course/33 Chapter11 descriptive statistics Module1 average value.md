...
<iframe width="560" height="315" src="https://www.youtube.com/embed/e1eWN0PrWu0?si=AHE0TfLRV2kQ-AY4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
- Formulas used  
  ...
  >$
  \begin{array}{ll}
  & \href{/math/core%20course/33%20Chapter11%20descriptive%20statistics%20Module1%20average%20value.html#_2-mode}{\textsf{mode}} \\
  & \href{/math/core%20course/33%20Chapter11%20descriptive%20statistics%20Module1%20average%20value.html#_3-median}{\textsf{median}} \\
  \overline{x}=\frac{x_1+x_2+\cdots+x_n}{n} & \href{/math/core%20course/33%20Chapter11%20descriptive%20statistics%20Module1%20average%20value.html#_1-mean}{\textsf{arithmetic mean formula}} \\
  \end{array}
  >$
...
- Formulas used  
  ...
  >$
  \begin{array}{ll}
   & \href{/math/core%20course/33%20Chapter11%20descriptive%20statistics%20Module1%20average%20value.html#_7-focus-4}{\textsf{comparison of averages}} \\
  \overline{x}=\frac{\sum_{i=1}^{n}w_ix_i}{\sum_{i=1}^{n}w_i} & \textsf{weighted average formula} \\
  \end{array}
  >$
