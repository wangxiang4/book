...
- Note: when __the change occurs continuously by month__,
  ...
  - __Whole year__: $a+a(1+p)+\cdots+a(1+p)^{11}$  
    ...
    $
    \begin{array}{ll}
    S_n=\frac{a_{1}(1-q^n)}{1-q} & \href{/math/0%20Core%20Course/21%20Chapter5%20sequences%20Module3%20geometric%20sequences.html#_3-sum-of-the-first-terms}{\textsf{geometric series sum formula}} \\
