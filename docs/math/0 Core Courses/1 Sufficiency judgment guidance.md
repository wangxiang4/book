...
- __(D)__: __each condition alone is sufficient__.
- __(E)__: __neither condition one nor two alone is sufficient__, and __even together they are not sufficient__.
...
- Show known conditions  
  ![Question sufficiency judgment figure Q-3 solve-1.svg](../../public/math/Core%20Courses/Question%20sufficiency%20judgment%20figure%20Q-3%20solve-1.svg)  
#### Conclusion
- Derived Solution  
  ::: wrap
  > $\boldsymbol{(C)}$  
...
- Derived Solution  
  ::: wrap
  > $\boldsymbol{(E)}$  
  > According to the Solution, get $\textsf{(1)}\,❌\;,\textsf{(2)}\,❌\;,\textsf{(1)}+\textsf{(2)}\,❌\;$, so choose $E$.

  :::
---

### $\fbox{7}\:\small (x+3)(x-5)=0$
::: wrap  
$
\begin{array}{lllll}
\textsf{(1)} \: x=-3 &
...
### $\fbox{8}\:\small (a+3)(b-5)=0$
::: wrap  
$
\begin{array}{lllll}
\textsf{(1)} \: a=-3 &
\textsf{(2)} \: \left|b\right|=5 & \\
\textsf{(A)} \: \textsf{(1)} &
\textsf{(B)} \: \textsf{(2)} & \\
\textsf{(C)} \: \textsf{(1)}+\textsf{(2)} &  
\textsf{(D)} \: \textsf{(1)},\textsf{(2)} & \\
...
### $\fbox{11}\:\small -2\lt x\lt 5$
::: wrap  
$
\begin{array}{lllll}
\textsf{(1)} \: \left|x\right| \lt 3 &
\textsf{(2)} \: \left|x\right| \lt 1 & \\
\textsf{(A)} \: \textsf{(1)} &
\textsf{(B)} \: \textsf{(2)} & \\
\textsf{(C)} \: \textsf{(1)}+\textsf{(2)} &  
\textsf{(D)} \: \textsf{(1)},\textsf{(2)} & \\
...
#### Solution
- Show known conditions  
  ![Question sufficiency judgment figure Q-11 solve-1.svg](../../public/math/Core%20Courses/Question%20sufficiency%20judgment%20figure%20Q-11%20solve-1.svg)  
#### Conclusion
- Derived Solution  
  ::: wrap
  > $\boldsymbol{(B)}$  
...
### $\fbox{13}\:\small 2\lt\left|x\right|\lt5$
::: wrap  
$
\begin{array}{lllll}
\textsf{(1)} \: x^2\le9 &
\textsf{(2)} \: \left|x\right|\ge3 & \\
\textsf{(A)} \: \textsf{(1)} &
\textsf{(B)} \: \textsf{(2)} & \\
\textsf{(C)} \: \textsf{(1)}+\textsf{(2)} &  
\textsf{(D)} \: \textsf{(1)},\textsf{(2)} & \\
...
### $\fbox{14}\:\small \left|x\right|\ge x$
::: wrap  
$
\begin{array}{lllll}
\textsf{(1)} \: x^2\le4 &
\textsf{(2)} \: \left|x\right|\gt1 & \\
\textsf{(A)} \: \textsf{(1)} &
\textsf{(B)} \: \textsf{(2)} & \\
\textsf{(C)} \: \textsf{(1)}+\textsf{(2)} &  
\textsf{(D)} \: \textsf{(1)},\textsf{(2)} & \\
...
:::
#### Solution
- $\textcolor{#228B22}{\fbox{1}}\:$Solve by separating the sign of $x$  
  ::: wrap  
  $
  \begin{array}{ll}
  ...
  $  
  :::
- $\textcolor{#228B22}{\fbox{2}}\:$Solve by using the sign chart method  
  ::: wrap  
  $
  \begin{array}{ll}
  x-\frac{1}{x}\lt0 \\
  ...
  \frac{(x-1)(x+1)}{x}\lt0 \\
  (x-1)(x+1)=0 \rightarrow x=1\lor-1 & \textsf{numerator}=0 \\
  x=0 & \textsf{denominator}=0 \\
  x=1,-1,0 & \textsf{critical points} \\
  (-\infty, -1), (-1,0), (0,1), (1, \infty) & \textsf{intervals} \\
  (-\infty, -1)\textsf{ analysis} \\
  x-1=- \\
  x+1=- \\
  x=- \\
  (–)(–)(–)=– \\
  ...
  $  
  :::  
  ![Question sufficiency judgment figure Q-15 solve-1.svg](../../public/math/Core%20Courses/Question%20sufficiency%20judgment%20figure%20Q-15%20solve-1.svg)  
#### Conclusion
- Derived Solution  
  ::: wrap
  > $\boldsymbol{(D)}$  
