...
## 2.Focus 1
__The finding work time__  
- Analyze using $\textsf{work time}=\frac{\textsf{amount of work}}{\textsf{work efficiency}}$


### $\fbox{51}\:$A job can be finished in $\small 30$ days when $\small A$ and $\small B$ work together. After the two of them work together for $\small 6$ days, $\small A$ leaves. $\small B$ continues working for another $\small 40$ days and finishes the job. How many days would it take $\small A$ to finish the job alone $\small \mathpunct{?}$.
::: wrap  
$
\begin{array}{lllll}
\textsf{(A)} \: 60 &
...
- $\textcolor{#228B22}{\fbox{1}}\:$Solve by setting up a system of equations  
  ...
  -40a=1-\frac{46}{30} \\
  -40a=-\frac{16}{30} \\
  a=\frac{-\frac{16}{30}}{-40}=\frac{16}{1200}=\frac{1}{75} \\
  A_{\textsf{work time}}=\frac{s}{v}=\frac{1}{\frac{1}{75}}=75 \\
  \end{array}
  $  
  :::
- $\textcolor{#228B22}{\fbox{2}}\:$Solve by using the work-time ratio method  
  ...
  $
  \begin{array}{ll}
  A_{\textsf{work time}}:B_{\textsf{work time}}=30\textsf{ days}:30\textsf{ days} \\
  A_{\textsf{work time}}:B_{\textsf{work time}}=6\textsf{ days}:46\textsf{ days} \\
  \Delta A_{\textsf{work time}}=30\textsf{ days}-6\textsf{ days}=24\textsf{ days} \\
  \Delta B_{\textsf{work time}}=46\textsf{ days}-30\textsf{ days}=16\textsf{ days} \\
  24\textsf{ days}=16\textsf{ days} \\
  3\textsf{ days}=2\textsf{ days} \\
  45\textsf{ days}=30\textsf{ days} \\
  A_{\textsf{work time}}=30+45=75 \\
  \end{array}
  $  
  :::
#### Conclusion
- Derived Solution  
  ::: wrap
  > $\boldsymbol{(D)}$  
  > According to the Solution, get $A_{\textsf{work time}}=75$, so choose $D$. 
...
- Formulas used  
  ...
  >$
  \begin{array}{ll}
  s=vt \Longrightarrow \frac{s_1}{s_2}=\frac{t_1}{t_2} & \href{/math/core%20course/10%20Chapter2%20word%20problems%20Module4%20work%20problems.html#_1-basic-formula}{\textsf{work basic formula}} \\
  t=\frac{s}{v}\Longrightarrow\frac{s_1}{s_2}=\frac{v_1}{v_2} & \href{/math/core%20course/10%20Chapter2%20word%20problems%20Module4%20work%20problems.html#_1-basic-formula}{\textsf{work basic formula}} \\
  \end{array}
  >$

  :::
- Work-time ratio method (used only when the work-completion condition is provided)  
  ::: wrap
  >$
  \begin{array}{ll}
  A_{\textsf{work time}}:B_{\textsf{work time}}=a\textsf{ days}:b\textsf{ days} \\
  A_{\textsf{work time}}:B_{\textsf{work time}}=c\textsf{ days}:d\textsf{ days} \\
  \Delta A_{\textsf{work time}}=\left|a-c\right|\textsf{ days} \\
  \Delta B_{\textsf{work time}}=\left|b-d\right|\textsf{ days} \\
  \left|a-c\right|\textsf{ days}=\left|b-d\right|\textsf{ days} \\
  \end{array}
  >$
...
- Formulas used  
  ...
  \begin{array}{ll}
  t=\frac{s}{v}\Longrightarrow\frac{s_1}{s_2}=\frac{v_1}{v_2} & \href{/math/core%20course/10%20Chapter2%20word%20problems%20Module4%20work%20problems.html#_1-basic-formula}{\textsf{work basic formula}} \\
  v=\frac{s}{t} \Longrightarrow \frac{v_1}{v_2}=\frac{t_2}{t_1} & \href{/math/core%20course/10%20Chapter2%20word%20problems%20Module4%20work%20problems.html#_1-basic-formula}{\textsf{work basic formula}} \\
...
- Show known conditions  
  ![Question work problems figure Q-57 solve-1.svg](../../public/math/core%20course/Question%20work%20problems%20figure%20Q-57%20solve-1.svg)  
...
- Formulas used  
  ...
  \begin{array}{ll}
  s=vt \Longrightarrow \frac{s_1}{s_2}=\frac{t_1}{t_2} & \href{/math/core%20course/10%20Chapter2%20word%20problems%20Module4%20work%20problems.html#_1-basic-formula}{\textsf{work basic formula}} \\
  \frac{v_1}{v_2}=\frac{t_2}{t_1} & \href{/math/core%20course/7%20Chapter2%20word%20problems%20Module3%20distance%20problems%20part1.html#straight-line-variable-speed-formulas}{\textsf{basic ratio of variable efficiency}} \\
  \end{array}
  >$
...
#### Solution
- Show known conditions  
  ![Question work problems figure Q-58 solve-1.svg](../../public/math/core%20course/Question%20work%20problems%20figure%20Q-58%20solve-1.svg)  
  ::: wrap  
  $
  \begin{array}{ll}
...
- Formulas used  
  ...
  >$
  \begin{array}{ll}
  s\Delta v=v_1v_2\Delta t & \href{/math/core%20course/7%20Chapter2%20word%20problems%20Module3%20distance%20problems%20part1.html#straight-line-variable-speed-formulas}{\textsf{time difference of variable efficiency}} \\
  t=\frac{s}{v}\Longrightarrow\frac{s_1}{s_2}=\frac{v_1}{v_2} & \href{/math/core%20course/10%20Chapter2%20word%20problems%20Module4%20work%20problems.html#_1-basic-formula}{\textsf{work basic formula}} \\
  \end{array}
  >$
...
#### Solution
- Show known conditions  
  ![Question work problems figure Q-60 solve-1.svg](../../public/math/core%20course/Question%20work%20problems%20figure%20Q-60%20solve-1.svg)  
  ::: wrap  
  $
  \begin{array}{ll}
